...
**[1]**: E.g. `CallClient.call(String userId, Map<String,String> headers)` in the Sinch Android APIs, and `-[SINCallClient callUserWithId:headers:]` in the Sinch iOS APIs.
